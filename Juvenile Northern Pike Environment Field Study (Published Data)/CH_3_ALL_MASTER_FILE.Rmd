...
```{r}
CH_1_ALL<-read.csv(file ="~/CH_1_Data/CH_1_seqtab_ALL_COMBINED.csv", header = TRUE, check.names = FALSE, row.names = 1)

CH_1_ALL<-as.matrix(CH_1_ALL)
CH_1_ALL_otu<-otu_table(CH_1_ALL, taxa_are_rows = TRUE)

CH_1_ALL_metadata<-read.csv("~/CH_1_Data/NMDS/CH_1_ALL_Metadata.csv", header=TRUE, check.names = FALSE, row.names = 1)

CH_1_ALL_metadata<-sample_data(CH_1_ALL_metadata)

CH_1_taxa<-read.csv(file ="~/CH_1_Data/Taxa_Graphs/CH_1_Clean_seq_REFERENCE.csv", header = TRUE, check.names = FALSE, row.names = 1)
...
ALL (H2O + NP) NMDS:
```{r}
CH_1_ALL_ASV<-read.csv("~/CH_1_Data/CH_1_seqtab_ALL_COMBINED.csv", header = TRUE, check.names = FALSE, row.names = 1)

CH_1_ALL_ASV_metadata<-read.csv("~/CH_1_Data/NMDS/CH_1_ALL_Metadata.csv", header=TRUE, check.names = FALSE)
...
```{r}
CH_1_H2O_ASV<-read.csv("~/NMDS/CH_1_seqs_taxa_H2O.csv", header = TRUE, check.names = FALSE, row.names = 1)

CH_1_H2O_ASV_metadata<-read.csv("~/CH_1_Data/NMDS/CH_1_H2O_metadata.csv", header=TRUE, check.names = FALSE)
...
```{r}
CH_1_NP_ASV<-read.csv("~/CH_1_Data/NMDS/CH_1_seqs_taxa_NP.csv", header = TRUE, check.names = FALSE, row.names = 1)

CH_1_NP_ASV_metadata<-read.csv("~/CH_1_Data/NMDS/CH_1_NP_metadata.csv", header=TRUE, check.names = FALSE)
...
```{r}
CH_1_ALLSEQS_Rare<-read.table("~/CH_1_Data/CH_1_Rarefaction_Alpha_Diversity/CH_1_seqtab_ALL_COMBINED.groups.rarefaction", header = TRUE)
...
CH_1_ALLSEQS_Rare_long<-read.csv(file = "~/CH_1_Data/CH_1_Rarefaction_Alpha_Diversity/CH_1_ALLSEQS_Rare_long.csv", header = TRUE)
...
CH_1_H2O_Rare_long<-read.csv(file = "~/CH_1_Data/CH_1_Rarefaction_Alpha_Diversity/CH_1_H2O_long.csv", header = TRUE)
CH_1_NP_Rare_long<-read.csv(file = "~/CH_1_Data/CH_1_Rarefaction_Alpha_Diversity/CH_1_NP_long.csv", header = TRUE)
...
CH_1_Top10_Taxa_Percent_ENV<-read.csv(file = "~/CH_1_Data/Taxa_Graphs/CH_1_Top10_Taxa_Percent_ENV.csv", header=TRUE, check.names = FALSE)
...
CH_1_Top10_Taxa_Percent_FISH<-read.csv(file = "~/CH_1_Data/Taxa_Graphs/CH_1_Top10_Taxa_Percent_FISH.csv", header=TRUE, check.names = FALSE)
...
CH_1_CranNP<-read.csv("~/CH_1_Data/Core_Microbiome/CH_1_CranNP.csv", header = TRUE, check.names = FALSE)
CH_1_CranNP.names<-make.names(CH_1_CranNP$Genus, unique = TRUE)
rownames(CH_1_CranNP)<-CH_1_CranNP.names
CH_1_CranNP$Genus<-NULL

CH_1_CranNP_metadata<-read.csv("~/CH_1_Data/Core_Microbiome/CH_1_CranNP_metadata.csv", header=TRUE, check.names = FALSE, row.names = 1)
...
```{r}
CH_1_FCLOW_NP<-read.csv("~/CH_1_Data/Core_Microbiome/CH_1_FCLOW_NP.csv", header = TRUE, check.names = FALSE)
...
CH_1_FC_LOW_NP_metadata<-read.csv("~/CH_1_Data/Core_Microbiome/CH_1_FCLOW_NP_metadata.csv", header=TRUE, check.names = FALSE, row.names = 1)
...
```{r}
CRAN_H2O_Log2<-read.csv(file = "~/CH_1_Data/Core_Microbiome/CH_1_CRAN_H2O_Log2.csv", header = TRUE, check.names = FALSE)

CRAN_NP_Log2<-read.csv(file = "~/CH_1_Data/Core_Microbiome/CH_1_Cran_NP_Log2.csv", header = TRUE, check.names = FALSE)
...
```{r}
FCLOW_H2O_Log2<-read.csv(file = "~/CH_1_Data/Core_Microbiome/CH_1_FCLOW_H2O_Log2.csv", header = TRUE, check.names = FALSE)

FCLOW_NP_Log2<-read.csv(file = "~/CH_1_Data/Core_Microbiome/CH_1_FCLOW_NP_Log2.csv", header = TRUE, check.names = FALSE)
...
```{r}
CH_1_ALL_ENV_Log2<-read.csv(file = "~/CH_1_Data/Core_Microbiome/CH_1_ENV_COMPARE_ALL_MERGE_Log2.csv", header = TRUE, check.names = FALSE)
...
CH_1_ALL_NP_Log2<-read.csv(file = "~/CH_1_Data/Core_Microbiome/CH_1_NP_ALL_MERGE_Log2.csv", header = TRUE, check.names = FALSE)
...
CH_1_NP_compare<-read.csv(file = "~/CH_1_Data/Core_Microbiome/CH_1_NP_Core_Compare.csv", header=TRUE, check.names = FALSE)
...
CH_1_Cran_Compare<-read.csv(file = "~/CH_1_Data/Core_Microbiome/CH_1_CRAN_COMPARE.csv", header=TRUE, check.names = FALSE)
...
CH_1_FCLOW_Compare<-read.csv(file = "~/CH_1_Data/Core_Microbiome/CH_1_FCLOW_COMPARE.csv", header=TRUE, check.names = FALSE)
...
CH_1_Tax4Fun_ASVs<-read.csv(file = "~/CH_1_Data/Tax4Fun/CH_1_Tax4Fun_ASVs.csv", header = TRUE, check.names = FALSE, row.names = 1)
...
CH_1_Tax4Fun_ENV_Proc<-read.csv(file = "~/CH_1_Data/Tax4Fun/CH_1_Tax4Fun_Analysis_Env_Sig.csv", header = TRUE, check.names = FALSE)
...
CH_1_Tax4Fun_Cell_Proc<-read.csv(file = "~/CH_1_Data/Tax4Fun/CH_1_Tax4Fun_Cell_Proc.csv", header = TRUE, check.names = FALSE)
...
CH_1_Tax4Fun_Meta<-read.csv(file = "~/CH_1_Data/Tax4Fun/CH_1_Tax4Fun_Metabolic.csv", header = TRUE, check.names = FALSE)
...
CH_1_Tax4Fun_Gen<-read.csv(file = "~/CH_1_Data/Tax4Fun/CH_1_Tax4Fun_Genetic_Proc.csv", header = TRUE, check.names = FALSE)
...
CH_1_Tax4Fun_Significance<-read.csv(file = "~/CH_1_Data/Tax4Fun/CH_1_Tax4Fun_significance.csv")
